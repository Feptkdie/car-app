...
class FavoriteScreen extends StatelessWidget {
  ...
  Widget _favoriteList(BuildContext ctx, int i) {
    return Padding(
      padding: EdgeInsets.only(
        ...
        top: MediaQuery.of(ctx).size.height * .006,
        bottom: MediaQuery.of(ctx).size.height * .006,
        right: MediaQuery.of(ctx).size.height * 0.01,
      ),
      child: Container(
        width: MediaQuery.of(ctx).size.height * 0.14,
            ...
            Flexible(
              child: Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    fontFamily: "Montserrat",
                    fontSize: MediaQuery.of(ctx).size.height * 0.013,
                    color: kTextColor,
                  ),
                ),
              ),
  ...
  Widget _cardList(BuildContext ctx) {
    return Expanded(
      child: ListView.builder(
        itemCount: favItem.length + 1,
        itemBuilder: (BuildContext ctx, int i) {
          return favItem.length > i
              ? Padding(
                  padding: EdgeInsets.symmetric(
                            ...
                            child: Column(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  child: Padding(
                                    padding: EdgeInsets.only(
                                        right: MediaQuery.of(ctx).size.height *
                                            0.015,
                                        top: MediaQuery.of(ctx).size.height *
                                            0.01),
                                    child: Icon(
                                      Icons.star_border_outlined,
                                      color: Colors.grey,
                                      size: MediaQuery.of(ctx).size.height *
                                          0.025,
                                    ),
                                  ),
                                ),
